...
Static contour PCA explorer for seashell images.

Run `npm install && make fingerprints export-static frontend-build && python3 -m http.server 8010`, then open `http://127.0.0.1:8010/`.
